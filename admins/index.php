      ...
      <div class="card card-outline card-info">
         ...
         <div class="card-body">
            <form method="POST">
               ...
               <div class="row">
                  <div class="col-6">
                     <button class="btn btn-block btn-primary" style="color: aliceblue;" type="submit"
                        name="login">Login</a>
                  </div>
               </div>
            </form>
...
if (isset($_POST['login'])) {
   ...
   $sql = "SELECT fullname,adminid,password,username,adminid FROM admin WHERE username=? and password=?";
