                        ...
                        <div class="col-md-12 table-responsive"><br>
                            <table id="" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    $total=0;
                                    $sql = "SELECT * from services,appointments,payments,lawyer WHERE appointments.lawyerid=lawyer.lawid AND appointments.appid=payments.appid AND appointments.serviceid=services.serviceid AND appointments.status = ?";
